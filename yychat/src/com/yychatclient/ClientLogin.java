...
public class ClientLogin extends JFrame{//类名
	JLabel jlbl1;//定义北部组件
	
	JTabbedPane jtp1;//定义中部组件
	JPanel jp2,jp3,jp4;
	...
	JButton jb1,jb2,jb3;//定义南部组件
	JPanel jp1;
	
	public ClientLogin(){//构造方法
		
		jlbl1=new JLabel(new ImageIcon("images/tou.gif"));//创建北部组件
		...
		jb1=new JButton(new ImageIcon("images/denglu.gif"));//创建南部组件
	...
	public static void main(String[] args) {
		ClientLogin clientLogin=new ClientLogin();//创建对象
